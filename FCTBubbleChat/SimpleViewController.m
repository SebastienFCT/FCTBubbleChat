...
- (void)makeTheView
{
    ...
    FCTBubbleData *data5 = [[FCTBubbleData alloc] initWithMessage:@"Oh I see, but how your cell will react, especially dealing with the reusability?"];
    FCTBubbleData *data6 = [[FCTBubbleData alloc] initWithMessage:@"We should have a try by posting many message here"];
    FCTBubbleData *data7 = [[FCTBubbleData alloc] initWithMessage:@"Ok, we can try this, have a look to these messages:"];
    ...
    FCTBubbleData *data9 = [[FCTBubbleData alloc] initWithMessage:@"2014-07-07 16:39:49.677 FCTBubbleChat[5166:60b] Cannot find executable for CFBundle 0x8f95430 </Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator7.1.sdk/System/Library/AccessibilityBundles/CertUIFramework.axbundle> (not loaded)"];
    FCTBubbleData *data10 = [[FCTBubbleData alloc] initWithMessage:@"原先大家以为这段拉丁文只是没有意义的组合，[1] 目的是让阅读者不要被文章内容所影响，而只专注于观察字型或版型，并借此填满空间。但根据美国拉丁学者Richard McClintock的研究，Lorem ipsum原来起源于西赛罗的《善恶之尽》（De finibus bonorum et malorum）："];
    FCTBubbleData *data11 = [[FCTBubbleData alloc] initWithMessage:@"账户是根据会计科目设置的，具有一定格式和结构，用于反映会计要素的增减变动情况及其结果的载体。每一个账户都有一个名称，用以说明该账户核算的经济内容。账户是根据会计科目设置的，因此账户的名称必须与会计科目一致。"];
