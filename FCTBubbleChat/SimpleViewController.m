...
- (void)makeTheView
{
    ...
    FCTBubbleData *data3 = [[FCTBubbleData alloc] initWithMessage:@"Hey here, is there any way to display long text?" AndType:BubbleFromMe AndAvatar:[UIImage imageNamed:@"fctbc_ic_custom_avatar.png"]];
    ...
    FCTBubbleData *data5 = [[FCTBubbleData alloc] initWithMessage:@"Oh I see, but how your cell will react, especially dealing with the reusability?" AndType:BubbleFromMe AndAvatar:[UIImage imageNamed:@"fctbc_ic_custom_avatar.png"]];
    ...
    FCTBubbleData *data7 = [[FCTBubbleData alloc] initWithMessage:@"Ok, we can can you send me a picture?" AndType:BubbleFromMe AndAvatar:[UIImage imageNamed:@"fctbc_ic_custom_avatar.png"]];
    FCTBubbleData *data8 = [[FCTBubbleData alloc] initWithPicture:[UIImage imageNamed:@"image.jpg"] AndType:BubbleFromSomeone];
    FCTBubbleData *data9 = [[FCTBubbleData alloc] initWithMessage:@"2014-07-07 16:39:49.677 FCTBubbleChat[5166:60b] Cannot find executable for CFBundle 0x8f95430 </Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator7.1.sdk/System/Library/AccessibilityBundles/CertUIFramework.axbundle> (not loaded)" AndType:BubbleFromMe AndAvatar:[UIImage imageNamed:@"fctbc_ic_custom_avatar.png"]];
    ...
    FCTBubbleData *data11 = [[FCTBubbleData alloc] initWithMessage:@"账户是根据会计科目设置的，具有一定格式和结构，用于反映会计要素的增减变动情况及其结果的载体。每一个账户都有一个名称，用以说明该账户核算的经济内容。账户是根据会计科目设置的，因此账户的名称必须与会计科目一致。" AndType:BubbleFromMe AndAvatar:[UIImage imageNamed:@"fctbc_ic_custom_avatar.png"]];
